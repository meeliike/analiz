...
INSERT INTO product_requests (barcode, product_name, category, brand, ingredients, user_note) VALUES
('1234567890123', 'Örnek Çikolata', 'çikolata', 'Örnek Marka', 'Şeker, kakao yağı, süt tozu', 'Bu bir test talebidir'),
('9876543210987', 'Test Ürünü', 'diğer', 'Test Markası', 'Su, şeker, aroma vericiler', 'Kullanıcı notu');
